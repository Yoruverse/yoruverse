...
function DevelopingIcon() {
    return (
        <section className="flex items-center rounded-lg gap-2 px-2.5 py-1.5 bg-zinc-800">
...
function NextJsIcon() {
    return (
        <section className="flex items-center rounded-lg gap-2 px-2.5 py-1.5 bg-zinc-800">
            <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="h-[18px]" preserveAspectRatio="xMidYMid">
                <defs>
