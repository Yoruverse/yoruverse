...
export default function Support() {
    ...
    return (
        <main id="support" className="flex flex-col items-center justify-center gap-32 h-dvh bg-page-3">
            <motion.header
                ...
                <section className="flex p-2.5 justify-center items-center gap-10 bg-zinc-900 rounded-xl">
                    ...
                    <motion.section
                        ...
                        whileHover={{ scale: 1.1 }}
                    >
                        <Link className="flex flex-col text-zinc-950 text-sm items-center font-medium justify-center gap-2.5 rounded-xl bg-white size-20" href={`/`}>
                            <svg version="1.1" className="size-5" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
		...
		c1.4,1.8,2,4.1,1.5,6.4c-0.8,4-4.4,6.8-8.5,6.8h-3.2c-0.5,0-1,0.4-1.1,0.9L13,25.2C12.9,25.7,12.5,26,12,26z"/>
                                ...
                                <g>
                                    <g>
                                        <path fill="#01308A" d="M12,26H7c-0.8,0-1.6-0.4-2.1-1c-0.5-0.6-0.7-1.4-0.5-2.2L8.7,4l0,0c0.3-1.2,1.3-2,2.6-2h8.6
			c2.3,0,4.4,1,5.9,2.8c1.4,1.8,2,4.1,1.5,6.4c-0.8,4-4.4,6.8-8.5,6.8h-3.2c-0.5,0-1,0.4-1.1,0.9L13,25.2C12.9,25.7,12.5,26,12,26z"
                                ...
                                <path fill="#019CDE" d="M29.3,11.3c0,0.1,0,0.2,0,0.3c-1,4.9-5.4,8.4-10.4,8.4h-2.5l-1.4,5.7C14.6,27.1,13.4,28,12,28h-2
                    ...
                    <section className="flex p-2.5 flex-col justify-center items-center bg-zinc-900 rounded-xl">
                        {rewards.map((reward, i) => (
                            <article key={i} className="flex w-full gap-2.5 items-center p-2.5">
                                ...
                                <aside className="grow flex flex-col gap-1 justify-center h-14">
                                    <header className="flex items-center gap-2.5">
                                        <p className="text-white font-medium">{reward.name}</p>
                                        <span className="bg-yellow-200 text-zinc-950 font-bold text-xs rounded px-1 py-0.5">{reward.type}</span>
                                    </header>
                                    <p className="text-zinc-400 text-sm">{reward.time}</p>
                                </aside>
                            </article>
                        ))}
                    </section>
